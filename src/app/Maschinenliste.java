...
public class Maschinenliste implements Iterable<Maschine> {
	...
	public void quickSort (Comparator <Maschine> comp) {
		...
		// oder größer im Vergleich zur Referenzgröße sind:
		...
		// Rekursiver Aufruf für die unsortierten Teillisten less und
		// greater. Achtung: equal enthält nur gleiche Elemente und
